...
class SmsDemo {
  ...
  public static function getAcsClient() {
    ...
    $accessKeyId = config('ali.sms.accessKeyId'); // AccessKeyId

    $accessKeySecret = config('ali.sms.accessKeySecret'); // AccessKeySecret
   ...
   * @return stdClass
   */
  public static function sendSms(string $telephone, int $captcha) {
    ...
    $request->setSignName(config('ali.sms.signName'));

    $request->setTemplateCode(config('ali.sms.templateCode'));
